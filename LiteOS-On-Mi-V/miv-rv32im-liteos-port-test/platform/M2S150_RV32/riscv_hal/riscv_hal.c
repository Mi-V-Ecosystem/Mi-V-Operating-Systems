 ...
 *   
 * SVN $Revision: 9682 $
 * SVN $Date: 2018-01-23 12:42:57 +0530 (Tue, 23 Jan 2018) $
 */
#include <stdlib.h>
#include <stdint.h>
#include <unistd.h>
...
uintptr_t handle_trap(uintptr_t mcause, uintptr_t mepc, uintptr_t sp)
{
    ...
    else
    {
        ...
        // Based on: https://riscv.org/specifications/privileged-isa/
        ...
        // SD WPRI[XLEN-2:23] TSR TW TVM MXR SUM MPRV XS[1:0] FS[1:0] MPP[1:0] WPRI SPP
        // MPIE WPRI SPIE UPIE MIE WPRI SIE UIE
